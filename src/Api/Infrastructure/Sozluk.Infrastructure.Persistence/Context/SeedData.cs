...
internal class SeedData
{
    private static List<User>GetUsers()
    {
        var result = new Faker<User>("tr")
                    ...
                    .RuleFor(i => i.Password, i => PasswordEncrytor.Encrypt( i.Internet.Password()))
    ...
    public async Task SeedAsync(IConfiguration configration)
    {



        var dbContextBuilder = new DbContextOptionsBuilder();
        dbContextBuilder.UseSqlServer(configration["SozlukDbConnectionString"]);
